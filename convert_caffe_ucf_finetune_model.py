...
def main():
    ...
    # input caffe model
    caffe_model_filename = '/home/kmhosny/Dropbox/c3d_ucf101_finetune_whole_iter_20000'

    # output dir/files
    model_dir = './models'
    if not os.path.exists(model_dir):
        os.makedirs(model_dir)
    output_model_filename = os.path.join(model_dir, 'sports1M_ucf_finetune_weights_{}.h5'.format(dim_ordering))
    output_json_filename = os.path.join(model_dir, 'sports1M_ucf_finetune_weights_{}.json'.format(dim_ordering))
